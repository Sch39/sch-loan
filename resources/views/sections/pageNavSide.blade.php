<div class="flex h-screen w-16 flex-col justify-between border-e z-[999]">
    <div class="z-[999] border-gray-100 bg-white">
    ...
    <div class="sticky inset-x-0 bottom-0 border-t border-gray-100 bg-white p-2 z-[999]">
        <form action="/logout">
            <button type="submit"
